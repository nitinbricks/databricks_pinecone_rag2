...
# MAGIC - Deploying systems such as Pinecone Index 
...
# MAGIC
# MAGIC <img src="https://github.com/nitinbricks/databricks_pinecone_rag/blob/main/Databricks_Pinecone_RAG_architecture.png?raw=true" style="float: right; margin-left: 10px"  width="1100px;">
